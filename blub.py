...
# Blub - the broker for remote desktops
...
app.config['LDAP_HOST'] = 'dc1.ecc.egr.uri.edu'

# Base DN of your directory
app.config['LDAP_BASE_DN'] = 'dc=ecc,dc=egr,dc=uri,dc=edu'

# Users DN to be prepended to the Base DN
app.config['LDAP_USER_DN'] = 'ou=Undergraduate Students,ou=Engineering Users'
...
app.config['LDAP_BIND_USER_DN'] = "WebAccountCreator@ecc.egr.uri.edu"

# The Password to bind to LDAP with
app.config['LDAP_BIND_USER_PASSWORD'] = "Test!2#4"
...
def manual_login():
    ...
    app.ldap3_login_manager.authenticate('jlemme', 'C')
